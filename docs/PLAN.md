...
Текущая фаза: **3. Проверка** (ждёт пользователя: добавить скрипт в OBS и сыграть демо).
...
- [ ] Загрузка в реальном OBS 32.2 под Python 3.12 без traceback, статус GSI в панели — **делает пользователь** (правка конфигов OBS из сессии заблокирована)
